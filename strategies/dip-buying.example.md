...
> **This is a paused example.** To activate: change `status: paused` to `status: active` in the frontmatter above, adjust `capital_monthly_usd` to your real amount, and ask Codex to run the daily workflow.
